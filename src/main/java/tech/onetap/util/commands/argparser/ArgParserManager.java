...
package tech.onetap.util.commands.argparser;

import tech.onetap.util.commands.api.argparser.IArgParser;
...
import tech.onetap.util.commands.api.exception.CommandNoParserForTypeException;
